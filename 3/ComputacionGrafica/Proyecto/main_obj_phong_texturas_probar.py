...
camara = Camara()
modelo1 = Modelo("modelos/cilindro.obj", draw_type=GL_TRIANGLES)
modelo2 = Modelo("modelos/esfera.obj", draw_type=GL_TRIANGLES)
...
#textura_id1 = cargar_textura("texturas/arena.png")  # Ajusta la ruta al archivo de textura
textura_id2 = cargar_textura("texturas/ajedrez.png")  # Ajusta la ruta al archivo de textura
...
def renderizar():
    ...
    configurar_luces() #PUSE AQUI ESTO PARA QUE SE QUEDE CONSTANTE Y NO SE MUEVA CON LA CAMARA
    # Dibujar el modelo con la textura aplicada
    modelo1.dibujar(textura_id = textura_id2, t_x=0, t_y=1, t_z=0,
                   angulo=0, eje_x=0, eje_y=0, eje_z=0, sx=1, sy=2, sz=1)

    modelo2.dibujar(textura_id = textura_id2, t_x=1, t_y=0.25, t_z=1,
