...
#from main_obj_phong_texturas import obtener_textura_actual, establecer_textura_actual, textura_id_1, textura_id_2
...
def consultar_estado_teclado(camara, delta_time):
    ...
    #if keys[K_1]:
    #    if obtener_textura_actual() != textura_id_1:
    #        establecer_textura_actual(textura_id_1)