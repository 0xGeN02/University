...
def renderizar():
    ...
    modelo1.dibujar(x=2.5, y=0, z=-1.5, angulo=0, eje_x=0, eje_y=1, eje_z=0, sx=0.25, sy=0.25, sz=0.25)  # Dibuja el modelo en el origen
    modelo1.dibujar(x=2.5, y=0, z=0.5, angulo=0, eje_x=0, eje_y=1, eje_z=0, sx=0.25, sy=0.25, sz=0.25)  # Dibuja el modelo en el origen
    modelo1.dibujar(x=2.5, y=0, z=2.5, angulo=0, eje_x=0, eje_y=1, eje_z=0, sx=0.25, sy=0.25, sz=0.25)  # Dibuja el modelo en el origen
    modelo1.dibujar(x=1.5, y=0, z=-2.5, angulo=0, eje_x=0, eje_y=1, eje_z=0, sx=0.25, sy=0.25, sz=0.25)  # Dibuja el modelo en el origen
    modelo1.dibujar(x=1.5, y=0, z=-0.5, angulo=0, eje_x=0, eje_y=1, eje_z=0, sx=0.25, sy=0.25, sz=0.25)  # Dibuja el modelo en el origen
    modelo1.dibujar(x=1.5, y=0, z= 1.5, angulo=0, eje_x=0, eje_y=1, eje_z=0, sx=0.25, sy=0.25, sz=0.25)  # Dibuja el modelo en el origen
    modelo1.dibujar(x=0.5, y=0, z=-1.5, angulo=0, eje_x=0, eje_y=1, eje_z=0, sx=0.25, sy=0.25, sz=0.25)  # Dibuja el modelo en el origen
    modelo1.dibujar(x=0.5, y=0, z=0.5, angulo=0, eje_x=0, eje_y=1, eje_z=0, sx=0.25, sy=0.25, sz=0.25)  # Dibuja el modelo en el origen
    modelo1.dibujar(x=0.5, y=0, z=2.5, angulo=0, eje_x=0, eje_y=1, eje_z=0, sx=0.25, sy=0.25, sz=0.25)  # Dibuja el modelo en el origen
    modelo1.dibujar(x=-0.5, y=0, z=-2.5, angulo=0, eje_x=0, eje_y=1, eje_z=0, sx=0.25, sy=0.25, sz=0.25)  # Dibuja el modelo en el origen
    modelo1.dibujar(x=-0.5, y=0, z=-0.5, angulo=0, eje_x=0, eje_y=1, eje_z=0, sx=0.25, sy=0.25, sz=0.25)  # Dibuja el modelo en el origen
    modelo1.dibujar(x=-0.5, y=0, z= 1.5, angulo=0, eje_x=0, eje_y=1, eje_z=0, sx=0.25, sy=0.25, sz=0.25)  # Dibuja el modelo en el origen
    modelo1.dibujar(x=-1.5, y=0, z=-1.5, angulo=0, eje_x=0, eje_y=1, eje_z=0, sx=0.25, sy=0.25, sz=0.25)  # Dibuja el modelo en el origen
