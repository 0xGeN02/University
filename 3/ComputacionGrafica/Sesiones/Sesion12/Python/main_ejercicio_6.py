...
def dibujar_objetos():
    dibujar_cubo(2.5, 0.5, 2.5, angulo=0, eje_x=0, eje_y=0, eje_z=0, sx=1, sy=1, sz=1)
    dibujar_cubo(2.5, 1.5, 2.5, angulo=90, eje_x=0, eje_y=1, eje_z=0, sx=1, sy=1, sz=1)
    dibujar_cubo(2.5, 2.5, 2.5, angulo=180, eje_x=0, eje_y=1, eje_z=0, sx=1, sy=1, sz=1)
    dibujar_cubo(2.5, 3.5, 2.5, angulo=270, eje_x=0, eje_y=1, eje_z=0, sx=1, sy=1, sz=1)
